<html>
    <head>
    	<style>
            ...
            .greenLed label:hover::after {
                -ms-filter: "progid:DXImageTransform.Microsoft.Alpha(Opacity=30)";
                filter: alpha(opacity=30);
                opacity: 0.3;
            }

            .greenLed input[type=checkbox]:checked + label:after {
	...
	<body>
            <div align="center" vertical-align="middle" style="transform: translateY(50%)">
     			<div class="greenLed">
                	<input type="checkbox" value="None" id="greenled" name="check" onclick="myFunction(6, 'greenled')">
                    <label for="greenled"></label>
				</div>
			</div>
	</body>
</html>